// PERFORMANCE OPTIMIZED VERSION - All Framer Motion removed for speed
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
          ...
          <div>
            <div className="space-y-0 font-sans text-white mb-16">
              <div className="text-5xl md:text-6xl font-bold leading-none mb-6">
                CRÉATION
              </div>

              <div className="text-5xl md:text-6xl font-bold leading-none text-purple-400 mb-8">
                AUGMENTÉE
              </div>

              <div className="text-xl md:text-2xl font-light text-gray-300 leading-tight">
                L'IA accélère.<br />
                L'expertise dirige.
              </div>
            </div>
          ...
          <div className="relative">
            ...
            <div className="mt-12 p-6 border-l-4 border-purple-400 bg-purple-400/5">
