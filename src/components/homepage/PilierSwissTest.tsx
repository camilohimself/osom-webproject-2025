    ...
    <section className="py-32 bg-black relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
          ...
          {/* Left: Typographie Swiss Pure */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1, delay: 0.2 }}
          >
            {/* Titre principal style Helvetica */}
            ...
            {/* Métriques Swiss Style - 3 colonnes précises */}
            <motion.div 
            ...
            {/* Process Swiss - 3 étapes éducatives */}
            <motion.div 
              className="space-y-8"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            {/* Citation Swiss - une seule ligne impactante */}
            <motion.div 
...
export default PilierSwissTest