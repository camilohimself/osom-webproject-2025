...
// SYSTÈME D'ICÔNES PREMIUM OSOM - Style cohérent palette brand
// Couleurs OSOM : Jaune #FFE000, Vert #00BFA6, Violet #9C27B0, Cyan, Rose
// Design : Bords arrondis, stroke-width: 2, style premium uniforme

export interface IconeOSOMProps {
  type: 
    // Business & Strategy
    | 'business-growth' | 'target' | 'consultation' | 'rocket' | 'trophy'
    // Performance & Technical  
    | 'lightning' | 'clock' | 'gauge' | 'shield' | 'chart'
    // Communication & Tools
    | 'phone' | 'message' | 'email' | 'document' | 'search'
    // Status & Feedback
    | 'check' | 'cross' | 'warning' | 'info' | 'star'
    // Design & Interface
...
const ICON_SVGS = {
  // BUSINESS & STRATEGY
  'business-growth': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="M18.7 8l-5.1 5.2-2.8-2.7L7 14.3"/></svg>`,
  'target': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>`,
  'consultation': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>`,
  'rocket': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.9 19.1C1 15.2 1 8.8 4.9 4.9s10.3-3.9 14.2 0 3.9 10.3 0 14.2-10.3 3.9-14.2 0z"/><path d="M13.5 10.5L19 5"/><path d="M10.5 13.5L16 19"/><path d="M16 8L8 16"/></svg>`,
  'trophy': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55.45 1 1 1h2c.55 0 1-.45 1-1v-2.34"/><path d="M2 14h20v-2c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v2z"/></svg>`,
  ...
  'gauge': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 14.66V20a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v4.34"/><path d="M2 10h20"/><path d="M8 6v4"/><path d="M16 6v4"/></svg>`,
  'shield': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91-6.91a6 6 0 0 1 7.94-7.94l3.77 3.77z"/></svg>`,
  ...
  // STATUS & FEEDBACK
  'check': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>`,
  'cross': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>`,
  ...
  'tools': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91-6.91a6 6 0 0 1 7.94-7.94l3.77 3.77z"/></svg>`,
...
export default function IconeOSOM({ 
  type, 
  size = 24, 
  className = '', 
  color = 'gray',
  ...
  if (!svg) {
    console.warn(`IconeOSOM: Type d'icône "${type}" non trouvé`)
    return null
  }
