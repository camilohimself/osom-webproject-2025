...
export const metadata: Metadata = {
  ...
  description: 'Agence Marketing VALAIS : 1239 recherches/mois → Expertise confirmée. Agence marketing digital Valais révolutionnaire. Marketing Humain × Claude IA. Résultats 140x supérieurs.',
  ...
  openGraph: {
    ...
    description: 'Agence Marketing VALAIS : 1239 recherches mensuelles confirment notre leadership. Marketing Humain × IA = 140x plus efficace.',
