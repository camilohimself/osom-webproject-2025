      ...
      <section className="py-32 lg:py-40 bg-gradient-to-b from-black via-purple-900/10 to-black text-white relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-light mb-6 leading-tight text-center" style={{fontFamily: 'Cera PRO, Inter, sans-serif'}}>
            Conquête digitale <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-600 font-bold">complète</span>
          </h1>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div
                key={index}
                className="bg-gradient-to-br from-purple-400/10 to-black border border-purple-400/30 rounded-xl p-8"
              >
      ...
      <section className="py-24 bg-gradient-to-b from-black to-purple-900/5">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <div className="bg-gradient-to-br from-purple-400/10 to-black border border-purple-400/30 rounded-2xl p-10">
          ...
          <div className="bg-gradient-to-br from-purple-400/10 to-black border border-purple-400/20 rounded-2xl p-8 md:p-12">
            <h3 className="text-2xl font-light text-white mb-6" style={{fontFamily: 'Cera PRO, Inter, sans-serif'}}>
              Pourquoi un <span className="text-purple-400 font-bold">partenariat long terme?</span>
            </h3>
            <div className="space-y-6 text-gray-300">
              <p className="leading-relaxed text-lg">
                Les projets Sur Mesure nécessitent <strong className="text-purple-400">un accompagnement stratégique continu</strong> sur 12-24 mois minimum. Ce n'est pas un site livré puis abandonné, c'est une <strong>conquête digitale progressive</strong> avec résultats mesurables chaque trimestre.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                <div className="bg-black/40 border border-purple-400/20 rounded-lg p-6">
                  <div className="text-purple-400 font-semibold mb-3">Mois 1-6: Fondations</div>
                  <ul className="text-sm text-gray-400 space-y-2">
                ...
                <div className="bg-black/40 border border-purple-400/20 rounded-lg p-6">
                  <div className="text-purple-400 font-semibold mb-3">Mois 7-12: Domination</div>
                  <ul className="text-sm text-gray-400 space-y-2">
                ...
                <div className="bg-black/40 border border-purple-400/20 rounded-lg p-6">
                  <div className="text-purple-400 font-semibold mb-3">Mois 13-18: Expansion</div>
                  <ul className="text-sm text-gray-400 space-y-2">
                ...
                <div className="bg-black/40 border border-purple-400/20 rounded-lg p-6">
                  <div className="text-purple-400 font-semibold mb-3">Mois 19-24: Leadership</div>
                  <ul className="text-sm text-gray-400 space-y-2">
          ...
          <div className="bg-black/60 border border-purple-400/30 rounded-xl px-8 py-4 mt-8">
            <p className="text-gray-300 text-sm text-center leading-relaxed">
              <strong className="text-purple-400">Partenariat stratégique:</strong> Consultant dédié, développement continu, SEO agressif, support 24/7, garanties contractuelles. Budget adapté à vos objectifs de croissance.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gradient-to-r from-purple-400/10 via-black to-purple-600/10 relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-light text-white mb-6" style={{fontFamily: 'Cera PRO, Inter, sans-serif'}}>
            Prêt pour une <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-600 font-bold">conquête digitale?</span>
          </h2>
