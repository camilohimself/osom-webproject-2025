...
export default function CreationSiteWebPage() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Nous connaissons le marché local et avons généré 688 clients en 6 mois pour un client PME, soit 8x plus efficace que leur méthode traditionnelle. Expertise locale + résultats vérifiés."
    },
    {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      {/* PUISSANCE TECHNOLOGIQUE - AUDACE TOTALE */}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-light text-white mb-8">
              Résultats de Notre <span className="font-bold" style={{color: '#70c1a9'}}>Technologie Avancée</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Pendant que d'autres promettent, nous délivrons des performances mesurables
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            {performanceResults.map((result, index) => (
              <div key={index} className="bg-gradient-to-br from-black/80 to-gray-900/80 backdrop-blur-xl rounded-3xl p-8 border border-gray-700/30 hover:border-teal-400/40 transition-all duration-500 group">
                <div className="mb-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center p-4 bg-black/40 rounded-xl border border-teal-400/20">
                      <span className="text-white font-medium">Notre Résultat</span>
                      <span className="font-bold text-xl" style={{color: result.color}}>
                        {result.ourResult}
                      </span>
                    </div>
                    
                    <div className="flex justify-between items-center p-4 bg-black/20 rounded-xl border border-gray-600/20">
                      <span className="text-gray-400">Moyenne Industrie</span>
                  ...
                  <div className="mt-4 text-center">
                    <span className="inline-block px-4 py-2 rounded-full text-sm font-semibold" style={{backgroundColor: `${result.color}20`, color: result.color}}>
                      {result.improvement}
                    </span>
                  </div>
                </div>
